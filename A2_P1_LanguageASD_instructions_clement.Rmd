...
library(pacman)
p_load(tidyverse, lme4, dplyr, MuMIn, performance, see)
```
...
hyp1_model_max <- lmerTest::lmer(CHI_MLU ~ Age*Diagnosis + Socialization1 + vIQ1 + nvIQ1 + (1+VISIT|ID), df, REML = F)
summary(hyp1_model_max)

#Basic model
hyp1_model1 <- lmerTest::lmer(CHI_MLU ~ Age + Diagnosis + (1+VISIT|ID), df, REML = F)
summary(hyp1_model1)

#Expanded model
hyp1_model2 <- lmerTest::lmer(CHI_MLU ~ Age + Diagnosis + MOT_MLU + (1+VISIT|ID), df, REML = F)

#Basic model with interaction between diagnosis and age
hyp1_model3 <- lmerTest::lmer(CHI_MLU ~ Age*Diagnosis + (1+VISIT|ID), df, REML = F)
summary(hyp1_model3)
...
anova(hyp1_model1, hyp1_model2, hyp1_model3, hyp1_model_max)
```
