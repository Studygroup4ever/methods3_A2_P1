...
#Basic model
hyp1_model1 <- lmerTest::lmer(CHI_MLU ~ Age + Diagnosis + (1|ID), df, REML = F)
summary(hyp1_model1)

#Expanded model
hyp1_model2 <- lmerTest::lmer(CHI_MLU ~ Age + Diagnosis + MOT_MLU + (1|ID), df, REML = F)

#Making a int model
fake_model <- lmerTest::lmer(CHI_MLU ~ MOT_MLU + (1|ID), df, REML = F)
anova(hyp1_model1, hyp1_model2)
```
